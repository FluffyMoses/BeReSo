		...
		{	
			while ($row = $result -> fetch_assoc())
			{
				...
				{			
					...
					$insert_hashtag .= File::read_file("templates/edit_taggroup-hashtag.html");
					$insert_hashtag = str_replace("(bereso_edit_taggroup_insert_hashtag_name)","- ".str_replace("#",null,$matches[0][$i]),$insert_hashtag);
					$insert_hashtag = str_replace("(bereso_edit_taggroup_insert_hashtag_value)",$matches[0][$i].$insert_after_hashtag,$insert_hashtag);
				}		
			}
		}
		// Tags
