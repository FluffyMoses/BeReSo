	...
	{	
		while ($row = $result -> fetch_assoc())
		{
			...
			{			
				...
				$insert_hashtag .= File::read_file("templates/new-hashtag.html");
				$insert_hashtag = str_replace("(bereso_new_item_insert_hashtag_name)","- ".str_replace("#",null,$match),$insert_hashtag);
				$insert_hashtag = str_replace("(bereso_new_item_insert_hashtag_value)",$match.$insert_after_hashtag,$insert_hashtag);
			}		
		}
	}
	// Tags
