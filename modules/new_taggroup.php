...
if ($action == "add")
{
	...
	{
			if ($form_taggroup_name_error == 1 or strlen($add_name) == 0) { $taggroup_new_addmessage = "<font color=\"red\">(bereso_template-new_taggroup_entry_error_name_characters)</font>"; } // name wrong char or empty
			...
			elseif (Tags::is_taggroup($user,$add_name) == true) { $taggroup_new_addmessage = "<font color=\"red\">(bereso_template-new_taggroup_entry_error_name_exists)</font>"; } // text wrong char
	}	
